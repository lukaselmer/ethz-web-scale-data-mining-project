...
public class BoilerpipeHTMLContentHandler implements ContentHandler {
	...
	public void startElement(String uri, String localName, String qName,
        ...
        if("A".equals(localName))
        {
            ...
            if (atts != null) {
                ...
                {
                    if("href".equals(atts.getQName(loopIndex)))
                    {
                        cur_href = atts.getValue(loopIndex);
                        break;
                    }
                }
            }
	...
	public void characters(char[] ch, int start, int length)
        ...
        if(isAnchor)
        {
            cur_anchor += (new String(ch, start, length)).trim();
        }
	...
	public TextDocument toTextDocument() {
		...
		return new TextDocument(getTitle(), getTextBlocks(), anchors);
	}
